		...
		<section ref={sectionRef} className="h-screen snap-start">
			...
			>
				<div className="max-w-5xl leading-relaxed">
					<p className="font-nosansthai font-light text-xl sm:text-4xl">
						<span className="text-[#FFEB52] font-medium">ความผันผวนของลำน้ำโขง</span>
						<br />
						และปัญหาการพังทลายของตลิ่งที่เกิดจากการกัดเซาะของน้ำ
						<br />
						กำลังก่อผลกระทบต่อชีวิตผู้คนจำนวนมากใน
						<span className="text-[#FFEB52] font-medium"> 8 จังหวัดของไทย</span>
					</p>
				</div>
			</motion.div>
		</section>
