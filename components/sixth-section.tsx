...
export default function SixthSection() {
	...
	return (
		<section
			ref={sectionRef}
			className="h-screen w-full bg-[#171918] text-white flex flex-col justify-center items-center gap-10 snap-start"
		>
			...
			<div className="w-5/6 flex justify-between items-center">
				...
				<div className="w-1/2 font-ibm flex flex-col gap-4">
					...
					<p className="font-ibm font-normal text-3xl">
						โฉมหน้าของแม่น้ำสายนี้ค่อยๆ แปรเปลี่ยนไป ปัจจัยหลักมาจากฝีมือมนุษย์
					</p>
